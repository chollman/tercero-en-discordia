...
export const FETCHING_BOOK_CATEGORIES = "FETCHING_BOOK_CATEGORIES";
export const FETCHING_BOOK_CATEGORIES_SUCCESS = "FETCHING_BOOK_CATEGORIES_SUCCESS";
export const FETCHING_BOOK_CATEGORIES_ERROR = "FETCHING_BOOK_CATEGORIES_ERROR";
export const FETCHING_RELATED_BOOKS = "FETCHING_RELATED_BOOKS";
export const FETCHING_RELATED_BOOKS_SUCCESS = "FETCHING_RELATED_BOOKS_SUCCESS";
export const FETCHING_RELATED_BOOKS_ERROR = "FETCHING_RELATED_BOOKS_ERROR";
export const SEARCHING_BOOKS = "SEARCHING_BOOKS";
export const SEARCHING_BOOKS_SUCCESS = "SEARCHING_BOOKS_SUCCESS";
export const SEARCHING_BOOKS_ERROR = "SEARCHING_BOOKS_ERROR";
